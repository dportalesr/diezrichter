...
class AppController extends Controller {
	...
	function beforeFilter(){
		...
		$this->m = array();
		$pagetitles = array(
			'about'=>'Diez Grados Richter.',
			'services'=>'Nuestros Servicios de Diseño.',
			'contacto'=>'Hola, ¿En qué te podemos ayudar?'
		);
		...
		if(isset($modules[$this->params['controller']]) && $cntrllr = $modules[$this->params['controller']]){
			...
			if(isset($pagetitles[$this->params['controller']]))
				$this->ts = $_ts = $pagetitles[$this->params['controller']];
